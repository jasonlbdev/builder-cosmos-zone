...
const communicationPlatforms: IntegrationPlatform[] = [
  {
    ...
    description:
      "Connect your Outlook email account with full Microsoft Graph API integration",
    icon: MessageSquare,
    color: "bg-blue-700",
    connected: false,
    status: "disconnected",
  ...
  },
  {
    ...
    name: "Gmail",
    description:
      "Integrate your Gmail account with advanced Google API features",
    icon: MessageSquare,
    color: "bg-red-500",
    connected: false,
    status: "disconnected",
  ...
  },
  {
    ...
    description:
      "Manage WhatsApp Business conversations and customer communications",
    icon: MessageSquare,
    color: "bg-green-500",
    connected: false,
    status: "disconnected",
  ...
  },
  {
    ...
    name: "Slack",
    description:
      "Connect your Slack workspace to manage messages alongside emails",
    icon: MessageSquare,
    color: "bg-purple-500",
    connected: false,
    status: "disconnected",
      ...
      setCategories((prev) =>
        prev.map((category) => ({
          ...
          platforms: category.platforms.map((platform) => ({
            ...
            status:
              data[platform.id]?.status ||
              (data[platform.id]?.connected ? "healthy" : "disconnected"),
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Connect your communication platforms to manage everything in one
              place
            </p>
          </div>
                    ...
                    {platform.category === "communication" ? (
                      ...
                      <>
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">
                            {platform.metrics?.files || 0}
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-muted-foreground">Storage</span>
                          <span className="font-medium">
                            {platform.metrics?.storage || "0 GB"}
                          </span>
                        </div>
                      </>
                    )}
            ...
            <Card className="border-dashed">
              <CardContent className="flex flex-col items-center justify-center py-8">
                ...
                <p className="text-muted-foreground text-center mb-4">
                  Connect your first platform below to start managing all your
                  communications and files in one place
                </p>
              </CardContent>
            </Card>
          )}
                        ...
                        <div className="flex items-center space-x-3">
                          <div className="flex items-center space-x-1">
                            <span className="text-sm text-muted-foreground">
                              {
                                category.platforms.filter((p) => p.connected)
                                  .length
                              }
                              /{category.platforms.length} connected
                            </span>
                          </div>
                          {category.isOpen ? (
                                ...
                                <div className="flex items-center space-x-3">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    {platform.connected && (
                                      <Badge
                                        variant="secondary"
                                        className="text-xs bg-green-100 text-green-800 mt-1"
                                      >
                                        <Check className="w-3 h-3 mr-1" />
                                        Connected
                                      </Badge>
